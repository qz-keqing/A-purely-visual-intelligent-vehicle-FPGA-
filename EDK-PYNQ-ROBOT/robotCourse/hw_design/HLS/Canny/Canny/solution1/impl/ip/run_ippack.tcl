# ==============================================================
# File generated on Tue Dec 30 00:00:39 +0800 2025
...
set Vendor      "user.org"
set Library     "user"
set IPName      "Canny_accel"
set Version     "1.0"
set DisplayName "Canny_accel"
set Revision    "2512300000"
set Description "Canny Accelerator IP"
set Device      "zynq"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set has_xpm_memory "0"
set sdx_kernel_name "Canny_accel"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir ""
set hdl_module_list {fifo_w8_d2_A
fifo_w32_d2_A
fifo_w32_d2_A
start_for_hlsStrmbkb
fifo_w8_d2_A_x
fifo_w32_d2_A_x
fifo_w32_d2_A_x
fifo_w32_d2_A_x
start_for_hlsStrmcud
fifo_w32_d2_A_x_x
fifo_w32_d2_A_x_x
fifo_w32_d4_A
fifo_w32_d4_A
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 img_inp_V W 0x0 "Data signal of img_inp_V" {{0 32 img_inp_V W 0 "Bit 31 to 0 Data signal of img_inp_V"}}} {0x18 img_out_V W 0x0 "Data signal of img_out_V" {{0 32 img_out_V W 0 "Bit 31 to 0 Data signal of img_out_V"}}} {0x20 rows W 0x0 "Data signal of rows" {{0 32 rows W 0 "Bit 31 to 0 Data signal of rows"}}} {0x28 cols W 0x0 "Data signal of cols" {{0 32 cols W 0 "Bit 31 to 0 Data signal of cols"}}} {0x30 low_threshold W 0x0 "Data signal of low_threshold" {{0 32 low_threshold W 0 "Bit 31 to 0 Data signal of low_threshold"}}} {0x38 high_threshold W 0x0 "Data signal of high_threshold" {{0 32 high_threshold W 0 "Bit 31 to 0 Data signal of high_threshold"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
