...
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    output wire [31:0]                   img_inp_V,
    output wire [31:0]                   img_out_V,
...
localparam
    ...
    ADDR_IER                   = 6'h08,
    ADDR_ISR                   = 6'h0c,
    ADDR_IMG_INP_V_DATA_0      = 6'h10,
    ADDR_IMG_INP_V_CTRL        = 6'h14,
    ADDR_IMG_OUT_V_DATA_0      = 6'h18,
    ADDR_IMG_OUT_V_CTRL        = 6'h1c,
    ADDR_ROWS_DATA_0           = 6'h20,
    ADDR_ROWS_CTRL             = 6'h24,
    ADDR_COLS_DATA_0           = 6'h28,
    ADDR_COLS_CTRL             = 6'h2c,
    ADDR_LOW_THRESHOLD_DATA_0  = 6'h30,
    ADDR_LOW_THRESHOLD_CTRL    = 6'h34,
    ADDR_HIGH_THRESHOLD_DATA_0 = 6'h38,
    ADDR_HIGH_THRESHOLD_CTRL   = 6'h3c,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_img_inp_V = 'b0;
    reg  [31:0]                   int_img_out_V = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_IMG_INP_V_DATA_0: begin
                    rdata <= int_img_inp_V[31:0];
                end
                ADDR_IMG_OUT_V_DATA_0: begin
                    rdata <= int_img_out_V[31:0];
                end
...
assign img_inp_V      = int_img_inp_V;
assign img_out_V      = int_img_out_V;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_img_inp_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_IMG_INP_V_DATA_0)
            int_img_inp_V[31:0] <= (WDATA[31:0] & wmask) | (int_img_inp_V[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_img_out_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_IMG_OUT_V_DATA_0)
            int_img_out_V[31:0] <= (WDATA[31:0] & wmask) | (int_img_out_V[31:0] & ~wmask);
    end
end
