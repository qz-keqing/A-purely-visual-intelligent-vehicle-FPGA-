...
void XCanny_accel_Set_img_inp_V(XCanny_accel *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCanny_accel_WriteReg(InstancePtr->Control_BaseAddress, XCANNY_ACCEL_CONTROL_ADDR_IMG_INP_V_DATA, Data);
}

u32 XCanny_accel_Get_img_inp_V(XCanny_accel *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCanny_accel_ReadReg(InstancePtr->Control_BaseAddress, XCANNY_ACCEL_CONTROL_ADDR_IMG_INP_V_DATA);
    return Data;
}

void XCanny_accel_Set_img_out_V(XCanny_accel *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCanny_accel_WriteReg(InstancePtr->Control_BaseAddress, XCANNY_ACCEL_CONTROL_ADDR_IMG_OUT_V_DATA, Data);
}

u32 XCanny_accel_Get_img_out_V(XCanny_accel *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCanny_accel_ReadReg(InstancePtr->Control_BaseAddress, XCANNY_ACCEL_CONTROL_ADDR_IMG_OUT_V_DATA);
    return Data;
}
