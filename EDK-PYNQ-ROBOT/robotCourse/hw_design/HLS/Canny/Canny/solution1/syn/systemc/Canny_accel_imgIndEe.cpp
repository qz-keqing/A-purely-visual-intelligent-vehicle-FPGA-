...
void Canny_accel_imgIndEe::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void Canny_accel_imgIndEe::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void Canny_accel_imgIndEe::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void Canny_accel_imgIndEe::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
