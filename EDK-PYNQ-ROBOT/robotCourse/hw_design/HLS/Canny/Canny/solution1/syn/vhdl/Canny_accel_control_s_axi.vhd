...
--        bit 1  - Channel 1 (ap_ready)
--        others - reserved
-- 0x10 : Data signal of img_inp_V
--        bit 31~0 - img_inp_V[31:0] (Read/Write)
-- 0x14 : reserved
-- 0x18 : Data signal of img_out_V
...
-- 0x2c : reserved
-- 0x30 : Data signal of low_threshold
--        bit 31~0 - low_threshold[31:0] (Read/Write)
-- 0x34 : reserved
-- 0x38 : Data signal of high_threshold
...
architecture behave of Canny_accel_control_s_axi is
    ...
    constant ADDR_IMG_INP_V_DATA_0      : INTEGER := 16#10#;
    constant ADDR_IMG_INP_V_CTRL        : INTEGER := 16#14#;
    constant ADDR_IMG_OUT_V_DATA_0      : INTEGER := 16#18#;
    constant ADDR_IMG_OUT_V_CTRL        : INTEGER := 16#1c#;
    ...
    constant ADDR_LOW_THRESHOLD_DATA_0  : INTEGER := 16#30#;
    constant ADDR_LOW_THRESHOLD_CTRL    : INTEGER := 16#34#;
    constant ADDR_HIGH_THRESHOLD_DATA_0 : INTEGER := 16#38#;
    constant ADDR_HIGH_THRESHOLD_CTRL   : INTEGER := 16#3c#;
    ...
    signal int_img_inp_V       : UNSIGNED(31 downto 0) := (others => '0');
    signal int_img_out_V       : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_IMG_INP_V_DATA_0 =>
                        rdata_data <= RESIZE(int_img_inp_V(31 downto 0), 32);
                    when ADDR_IMG_OUT_V_DATA_0 =>
                        rdata_data <= RESIZE(int_img_out_V(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    img_inp_V            <= STD_LOGIC_VECTOR(int_img_inp_V);
    img_out_V            <= STD_LOGIC_VECTOR(int_img_out_V);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMG_INP_V_DATA_0) then
                    int_img_inp_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_img_inp_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMG_OUT_V_DATA_0) then
                    int_img_out_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_img_out_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
