...
Arduino_programs_dict = {'monomotor':"/usr/local/lib/python3.6/dist-packages/PYNQ_Car/Overlay/bimotor_Car.bin",'bimotor':"/usr/local/lib/python3.6/dist-packages/PYNQ_Car/Overlay/bimotor_Car.bin"}
...
class Car_Arduino(object):
    ...
    def get_accl(self):
        ...
        return [float("{0:.2f}".format(ax)),
                float("{0:.2f}".format(ay)),
                float("{0:.2f}".format(az))]
    ...
    def get_gyro(self):
        ...
        return [float("{0:.2f}".format(gx)),
                float("{0:.2f}".format(gy )),
                float("{0:.2f}".format(gz))]
